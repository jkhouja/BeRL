...
- **WandB:** project=TOM_EXP run=s2-SS-07-SS-gemma_kl0.1-dcfg_smoke_mix_gemma-gemma-2-2b-it-frozenRM-nobaseline-power-k4-llmin-4-lr5e-7-kl0.1-n16-r1 _(paste link after launch)_
