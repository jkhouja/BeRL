...
- **WandB:** project=TOM_EXP run=s2-SS-01-SS-0.5B_frozen-dcfg_smoke_mix-Qwen2.5-0.5B-Instruct-frozenRM-nobaseline-power-k4-llmin-6-lr5e-7-kl0.05-n16-r1 _(paste link after launch)_
