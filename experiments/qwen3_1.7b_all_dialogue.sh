#!/bin/bash
# Qwen3-1.7B all-dialogue training — actor-as-RM, power reward
# Matches qwen2.5_3b_all_dialogue.sh config but with Qwen3-1.7B on tom env
# Uses merged_all_dialogue_eval_prompt.parquet (9-source combined dataset, 26,334 rows)
