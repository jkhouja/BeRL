#!/bin/bash
# Gemma2-2b-it: Combined dialogue+CGA training with LL reward, FANToM eval
# Uses fold_system_prompt=True to handle Gemma2's lack of system role support
